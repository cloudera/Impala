...
export CDH_GBN=${GLOBAL_BUILD_NUMBER:-181102}

export IMPALA_HADOOP_VERSION_BASE=3.0.0-alpha3-cdh6.x
export IMPALA_HADOOP_VERSION=${IMPALA_HADOOP_VERSION_BASE}-${CDH_GBN}
export IMPALA_HBASE_VERSION_BASE=2.0.0-cdh6.x
export IMPALA_HBASE_VERSION=${IMPALA_HBASE_VERSION_BASE}-${CDH_GBN}
export IMPALA_HIVE_VERSION_BASE=2.1.1-cdh6.x
export IMPALA_HIVE_VERSION=${IMPALA_HIVE_VERSION_BASE}-${CDH_GBN}
export IMPALA_SENTRY_VERSION_BASE=2.0.0-cdh6.x
export IMPALA_SENTRY_VERSION=${IMPALA_SENTRY_VERSION_BASE}-${CDH_GBN}
export IMPALA_PARQUET_VERSION=1.9.0-cdh6.x
export IMPALA_AVRO_JAVA_VERSION=1.8.2-cdh6.x
export KUDU_JAVA_VERSION=1.5.0-cdh6.x-SNAPSHOT
