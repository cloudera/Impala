...
export IMPALA_TOOLCHAIN_BUILD_ID=140-6af6471fbb
...
export IMPALA_KUDU_VERSION=cdh5-1.6.0_5.14.4
unset IMPALA_KUDU_URL

# Kudu version used to identify Java client jar from maven
export KUDU_JAVA_VERSION=1.6.0-cdh5.14.4-SNAPSHOT

# Versions of Hadoop ecosystem dependencies.
# ------------------------------------------
export CDH_MAJOR_VERSION=5
export IMPALA_HADOOP_VERSION=2.6.0-cdh5.14.4-SNAPSHOT
unset IMPALA_HADOOP_URL
export IMPALA_HBASE_VERSION=1.2.0-cdh5.14.4-SNAPSHOT
unset IMPALA_HBASE_URL
export IMPALA_HIVE_VERSION=1.1.0-cdh5.14.4-SNAPSHOT
unset IMPALA_HIVE_URL
export IMPALA_SENTRY_VERSION=1.5.1-cdh5.14.4-SNAPSHOT
unset IMPALA_SENTRY_URL
export IMPALA_PARQUET_VERSION=1.5.0-cdh5.14.4-SNAPSHOT
