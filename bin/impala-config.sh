...
: ${IMPALA_TOOLCHAIN_BUILD_ID=328-bdade2a197}
...
# kudu5.10.0-rc3 is the git tag, p1 is the toolchain patch version (needed for building
# in the toolchain only, not affecting the Kudu bits).
export IMPALA_KUDU_VERSION=kudu5.10.0-rc3-p1
...
export IMPALA_HADOOP_VERSION=${IMPALA_HADOOP_VERSION:-2.6.0-cdh5.10.1-SNAPSHOT}
export IMPALA_HBASE_VERSION=${IMPALA_HBASE_VERSION:-1.2.0-cdh5.10.1-SNAPSHOT}
export IMPALA_HIVE_VERSION=${IMPALA_HIVE_VERSION:-1.1.0-cdh5.10.1-SNAPSHOT}
export IMPALA_SENTRY_VERSION=${IMPALA_SENTRY_VERSION:-1.5.1-cdh5.10.1-SNAPSHOT}
export IMPALA_PARQUET_VERSION=${IMPALA_PARQUET_VERSION:-1.5.0-cdh5.10.1-SNAPSHOT}
