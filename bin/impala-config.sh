...
export KUDU_JAVA_VERSION=1.4.0-cdh5.12.0

# Versions of Hadoop ecosystem dependencies.
# ------------------------------------------
export CDH_MAJOR_VERSION=5
export IMPALA_HADOOP_VERSION=2.6.0-cdh5.12.0
export IMPALA_HBASE_VERSION=1.2.0-cdh5.12.0
export IMPALA_HIVE_VERSION=1.1.0-cdh5.12.0
export IMPALA_SENTRY_VERSION=1.5.1-cdh5.12.0
export IMPALA_PARQUET_VERSION=1.5.0-cdh5.12.0
