...
: ${IMPALA_TOOLCHAIN_BUILD_ID=313-14bc27d5d2}
...
# cdh5-1.2.0_5.10.0-rc2 is the git tag, p1 is the toolchain patch version
export IMPALA_KUDU_VERSION=cdh5-1.2.0_5.10.0-rc2-p1
