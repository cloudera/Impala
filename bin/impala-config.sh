...
export IMPALA_TOOLCHAIN_BUILD_ID=485-350c9e6e7a
...
export IMPALA_KUDU_VERSION=cdh5-1.4.0_5.12.2

# Kudu version used to identify Java client jar from maven
export KUDU_JAVA_VERSION=1.4.0-cdh5.12.2-SNAPSHOT

# Versions of Hadoop ecosystem dependencies.
# ------------------------------------------
export CDH_MAJOR_VERSION=5
export IMPALA_HADOOP_VERSION=2.6.0-cdh5.12.2-SNAPSHOT
export IMPALA_HBASE_VERSION=1.2.0-cdh5.12.2-SNAPSHOT
export IMPALA_HIVE_VERSION=1.1.0-cdh5.12.2-SNAPSHOT
export IMPALA_SENTRY_VERSION=1.5.1-cdh5.12.2-SNAPSHOT
export IMPALA_PARQUET_VERSION=1.5.0-cdh5.12.2-SNAPSHOT
