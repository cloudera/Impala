...
export IMPALA_HADOOP_VERSION=2.6.0-cdh5.5.1
export IMPALA_HBASE_VERSION=1.0.0-cdh5.5.1
export IMPALA_HIVE_VERSION=1.1.0-cdh5.5.1
export IMPALA_SENTRY_VERSION=1.5.1-cdh5.5.1
export IMPALA_LLAMA_VERSION=1.0.0-cdh5.5.1
export IMPALA_PARQUET_VERSION=1.5.0-cdh5.5.1
