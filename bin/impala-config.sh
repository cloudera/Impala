...
export IMPALA_TOOLCHAIN_BUILD_ID=72-0dadd1939a
...
export IMPALA_KUDU_VERSION=cdh5-1.5.0_5.13.3

# Kudu version used to identify Java client jar from maven
export KUDU_JAVA_VERSION=1.5.0-cdh5.13.3-SNAPSHOT

# Versions of Hadoop ecosystem dependencies.
# ------------------------------------------
export CDH_MAJOR_VERSION=5
export IMPALA_HADOOP_VERSION=2.6.0-cdh5.13.3-SNAPSHOT
export IMPALA_HBASE_VERSION=1.2.0-cdh5.13.3-SNAPSHOT
export IMPALA_HIVE_VERSION=1.1.0-cdh5.13.3-SNAPSHOT
export IMPALA_SENTRY_VERSION=1.5.1-cdh5.13.3-SNAPSHOT
export IMPALA_PARQUET_VERSION=1.5.0-cdh5.13.3-SNAPSHOT
