...
ir_functions = [
  ...
  ["PHJ_PROCESS_BUILD_BATCH",
   "_ZN6impala23PartitionedHashJoinNode17ProcessBuildBatchEPNS_8RowBatchEb"],
  ...
  ["PHJ_INSERT_BATCH",
   "_ZN6impala23PartitionedHashJoinNode9Partition11InsertBatchENS_13TPrefetchMode4typeEPNS_12HashTableCtxEPNS_8RowBatchERKSt6vectorINS_19BufferedTupleStream6RowIdxESaISA_EE"],
