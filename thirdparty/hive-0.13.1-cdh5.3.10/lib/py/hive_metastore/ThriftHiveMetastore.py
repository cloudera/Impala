      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i445 in xrange(_size441):
            ...
            self.tbl_types.append(_elem446)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i466 in xrange(_size462):
            ...
            self.tbl_names.append(_elem467)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i522 in xrange(_size518):
            ...
            self.part_vals.append(_elem523)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class exchange_partition_args:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i529 in xrange(_size525):
            ...
            self.partitionSpecs[_key530] = _val531
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.partitionSpecs is not None:
      ...
      for kiter532,viter533 in self.partitionSpecs.items():
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i559 in xrange(_size555):
            ...
            self.group_names.append(_elem560)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class get_partitions_ps_with_auth_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i600 in xrange(_size596):
            ...
            self.group_names.append(_elem601)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.group_names))
      for iter603 in self.group_names:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i650 in xrange(_size646):
            _elem651 = Partition()
            _elem651.read(iprot)
            self.new_parts.append(_elem651)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
