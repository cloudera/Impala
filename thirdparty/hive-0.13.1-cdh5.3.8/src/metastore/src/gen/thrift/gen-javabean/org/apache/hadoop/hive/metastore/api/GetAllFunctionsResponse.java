            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.functions = new ArrayList<Function>(_list442.size);
                for (int _i443 = 0; _i443 < _list442.size; ++_i443)
                {
                  Function _elem444; // required
                  _elem444 = new Function();
                  _elem444.read(iprot);
                  struct.functions.add(_elem444);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.functions != null) {
        if (struct.isSetFunctions()) {
          oprot.writeFieldBegin(FUNCTIONS_FIELD_DESC);
          {
            ...
            for (Function _iter445 : struct.functions)
            {
      ...
      if (struct.isSetFunctions()) {
        {
          ...
          for (Function _iter446 : struct.functions)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.functions = new ArrayList<Function>(_list447.size);
          for (int _i448 = 0; _i448 < _list447.size; ++_i448)
          {
            Function _elem449; // required
            _elem449 = new Function();
            _elem449.read(iprot);
            struct.functions.add(_elem449);
          }
        }
        struct.setFunctionsIsSet(true);
      }
