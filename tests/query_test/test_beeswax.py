...
class TestBeeswax(ImpalaTestSuite):
  ...
  def _assert_invalid_handle(self, fn):
    ...
    try:
      ...
      # IMPALA-7133: we may not get the correct message back because of IMPALA-7133
      assert (("Query id" in str(e) and "not found" in str(e)) or
               "Default TException" in str(e)), str(e)
